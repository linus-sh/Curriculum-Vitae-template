...
![rakutabi](./screen_shot/rakutabi.png)
  ...
  - 担当範囲
    ...
    + NGINXを用いたリバースプロキシの構築
      * NextJSは3000番ポートでListenする為、NGINXをリバースプロキシサーバーとして導入しました。
...
　コーディングブートキャンプではJavaScript を軸として ReactJS や Redux といったフロントエンドから、NodeJs や ExpressJS 等のバックエンドまでモダンな技術を学んできました。<br>
　またそれに加えてAWSの学習には力を入れてきました。ブートキャンプ卒業のための最終プロジェクトでは 独学でAWSを学びWeb アプリの実行環境の構築、GitHubと連携したCI/CD環境を構築し、アプリ開発に大きく貢献しました。

<br><br>
【リモート環境下での開発経験】<br>
　コーディングブートキャンプの最終プロジェクトでは開発メンバーの半分がリモートの環境で開発を行ってきました。開発期間中は朝と夕方にビデオ会議システムで定期的にミーティングを行い、またチャットツールも併用することで定期ミーティング以外にも随時コミュニケーションを取り続け、アプリ開発を完成に導くことができました。
...
<br><br>
【これからやりたいこと】<br>
学んできた技術を生かしてフルスタックで、特にバックエンド、インフラサイドに力を入れたいと考えています。<br>
